 ...
 * @param {Array} [buttons] - Buttons as {label, onClick, variant?}, variant one of "primary" (default) | "secondary" | "danger". When omitted, the store passes `undefined` through and Dialog.jsx supplies its own default "Close" button — the store does NOT default this (single source of truth, see §2).
 */
